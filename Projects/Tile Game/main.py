...
## Currently on Part 16 of videos
...
class Game(object):
    ...
    def draw(self):
        ...
        if self.draw_debug:
            ...
            for bullet in self.bullets:
                pg.draw.rect(self.screen, CYAN, self.camera.apply_rect(bullet.hit_rect), 1)
    ...
    def show_win_screen(self):
        self.screen.fill(BLACK)
        self.draw_text("YOU WIN", self.title_font, 100, YELLOW, WIDTH / 2, HEIGHT / 2, align="center")
